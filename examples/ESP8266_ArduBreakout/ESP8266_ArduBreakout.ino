...
void movePaddle()
{
  //Move right
    ...
    if(xPaddle >=  WIDTH - 14) xPaddle = WIDTH - 14;
...
boolean pollFireButton(int n)
{
  ...
  //  Serial.println (String (arduboy.pressed(A_BUTTON)) + " " + String (arduboy.pressed(B_BUTTON)));
    pad = arduboy.pressed(A_BUTTON) || arduboy.pressed(B_BUTTON);
